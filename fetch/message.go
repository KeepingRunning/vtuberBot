...
func main() {
	...
	c.OnGift(func(gift *message.Gift) {
		...
		fmt.Printf("[礼物基本信息] Action=%s BatchComboId=%s BatchComboSend=%s CoinType=%s\n", gift.Action, gift.BatchComboId, gift.BatchComboSend, gift.CoinType)
		// }
	})
	// 上舰事件
